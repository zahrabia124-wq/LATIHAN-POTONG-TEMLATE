<!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="tabel.profile.php">
                    <!-- untuk mencari icon disidebar dpt diambil
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="tabel.skill.php">
                    <!-- untuk mencari icon disidebar dpt diambil
                     dari fontawesome.com -->
                    <i class="fas fa-fw fa-table"></i>
                    <span>Skill</span></a>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="tabel.education.php">
                    <!-- untuk mencari icon disidebar dpt diambil
                     dari fontawesome.com -->
                    <i class="fas fa-fw fa-table"></i>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="tabel.training.php">
                    <!-- untuk mencari icon disidebar dpt diambil
                     dari fontawesome.com -->
                    <i class="fas fa-fw fa-table"></i>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="tabel.job.php">
                    <!-- untuk mencari icon disidebar dpt diambil
                     dari fontawesome.com -->
                    <i class="fas fa-fw fa-table"></i>
                    <span>Job</span></a>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="tabel.Professional.php">
                    <!-- untuk mencari icon disidebar dpt diambil
                     dari fontawesome.com -->
                    <i class="fas fa-fw fa-table"></i>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="tabele_toolsphp">
                    <!-- untuk mencari icon disidebar dpt diambil
                     dari fontawesome.com -->
                    <i class="fas fa-fw fa-table"></i>
                    <span>Icon Tools</span></a>
            </li>
            <!-- Nav Item - Tables -->
            <li class="nav-item">
